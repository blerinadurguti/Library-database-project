...
insert into pagesa (paymentID, billTime, readerID, workerID, billPrice, typeOfPayment)
values  (90, null, null, 20, 0.5, 'Registration'),
        (91, null, null, 21, 0.5, 'Registration'),
        (92, null, null, 22, 0.5, 'Registration'),
        (93, null, null, 23, 0.5, 'Registration'),
        (94, null, null, 24, 0.5, 'Registration'),
        (95, null, null, 25, 0.5, 'Registration'),
        (96, null, null, 21, 0.5, 'Registration'),
        (97, null, null, 27, 0.5, 'Registration'),
        (98, null, null, 25, 0.5, 'Registration'),
        (99, null, null, 29, 0.5, 'Registration'),
        (100, null, null, 30, 0.5, 'Registration'),
        (101, null, null, 28, 0.5, 'Registration');


insert into regjistrimi (registrationID, registrationDate, billID, readerID, registrationLengthDays, registrationActive, typeOfRegistration)
values  (110, '2020-12-26', 90, null, 365, 1, 'Anetare'),
        (111, '2019-11-22', 91, null, 365, 1, 'Anetare'),
        (112, '2019-05-06', 92, null, 365, 1, 'Anetare'),
        (113, '2021-12-26', 93, null, 365, 1, 'Anetare'),
        (114, '2021-12-26', 94, null, 365, 1, 'Anetare'),
        (115, '2021-12-26', 95, null, 365, 1, 'Anetare'),
        (116, '2021-12-26', 96, null, 365, 1, 'Anetare'),
        (117, '2021-12-26', 97, null, 365, 1, 'Anetare'),
        (118, '2021-12-26', 98, null, 365, 1, 'Anetare'),
        (119, '2021-12-26', 99, null, 365, 1, 'Anetare'),
        (120, '2021-12-26', 100, null, 365, 1, 'Anetare'),
        (121, '2021-12-26', 101, null, 365, 1, 'Anetare');




insert into lexuesi (readerID, readerName, readerSurname, readerParentName, readerGender, readerDoB, readerAddress, readerMunicipality, readerPhone, readerEmail, readerOccupation)
values  (10, 'Art', 'Tmava', 'Selim', 'M', '2002-02-11', 'William Walker', 1, '38349123456', 'atmava@gmail.com', 'Student'),
        (11, 'Era', 'Hajdari', 'Ismajl', 'F', '2000-04-03', 'Bill Klinton', 1, '38344321546', 'eahajda@gmail.com', 'Mesuese'),
        (12, 'Dren', 'Shehu', 'Safet', 'M', '2001-01-17', 'Ismail Kodra', 5, '38346768143', 'drensh1@gmail.com', 'Student'),
        (13, 'Dimal', 'Kryeziu', 'Smajl', 'M', '2000-11-05', 'Sami Frasheri', 7, '38345879687', 'dkryeziu13@gmail.com', 'Student'),
        (14, 'Fjolla', 'Korenica', 'Hamez', 'F', '2004-07-30', '4 Llullat', 9, '38349871220', 'fjollak@gmail.com', 'Nxenese'),
        (15, 'Aulona', 'Berisha', 'Kadri', 'F', '2003-05-04', 'Aleksandri i Madh', 11, '38344657881', 'aulonab32@gmail.com', 'Nxenese'),
        (16, 'Drenusha', 'Selimi', 'Selman', 'F', '2002-10-22', 'Bekim Isma', 13, '38349555342', 'ds11@gmail.com', 'Studente'),
        (17, 'Melos', 'Elshani', 'Xhevdet', 'M', '1995-12-05', 'Ukshin Hoti', 15, '38346332123', 'eoselshani@gmail.com', 'Profesor'),
        (18, 'Klea', 'Dina', 'Albin', 'F', '1990-04-04', 'Isa Boletini', 17, '38349678555', 'dinaklea@gmail.com', 'Mjeke'),
        (19, 'Anjeza', 'Plakolli', 'Arif', 'F', '1994-06-25', 'Bajram Curri', 19, '38343889787', 'anjezap32@gmail.com', 'Edukatore'),
        (20, 'Artan', 'Meha', 'Pajtim', 'M', '1992-11-11', 'Zahir Pajaziti', 12, '38349999567', 'mehaartan92@gmail.com', 'Inxhinier'),
        (21, 'Ensar', 'Hoti', 'Armend', 'M', '1998-09-09', 'Deshmoret e Lirise', 6, '38349677655', 'ensarhh@gmail.com', 'Avokat');
...
values ('61', '10', '2021-12-01', '2021-12-16', '27', ''),
       ...
       ('63', '11', '2022-10-12', '2022-12-20', '22 ', ''),
       ('65', '13', '2016-08-15', '2016-09-01', '21', ''),
       ('67', '14', '2019-11-09', '2019-11-26', '21', ''),
       ('69', '16', '2021-12-11', '2021-12-16', '23', ''),
       ('66', '14', '2020-10-09', '2021-10-15', '21', ''),
       ('63', '14', '2020-10-09', '2021-10-15', '21', ''),
